...
filenames = [f[:-4] for f in os.listdir('C:/Dev/100style-retarget/fbx') if f.endswith('.fbx')]

for file in filenames:
    
    input_file = 'C:/Dev/100style-retarget/fbx/'+file+'.fbx'
    output_file = 'C:/Dev/100style-retarget/bvh/'+file+'.bvh'
